...
class DataHandler:
    ...
    def add_data(self, data: dict, level: str, client_id: str = None):
        ...
        if level not in ["batch", "epoch", "server", "info"]:
            raise ValueError("Level must be 'batch', 'epoch', 'server', or 'info'")
    ...
    def get_data(self, level: str, client_id: str = None):
        ...
        return self._get_df(level, client_id)
