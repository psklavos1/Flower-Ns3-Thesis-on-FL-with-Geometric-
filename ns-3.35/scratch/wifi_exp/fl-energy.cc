...
double
FLEnergy::GetA (void) const
{
  return m_A;
}
void
FLEnergy::SetA (double A)
{
  m_A = A;
}

double
FLEnergy::GetB (void) const
{
  return m_B;
}
void
FLEnergy::SetB (double B)
{
  m_B = B;
}

double
FLEnergy::GetC (void) const
{
  return m_C;
}

void
FLEnergy::SetC (double C)
{
  m_C = C;
}

double
FLEnergy::GetD (void) const
{
  return m_D;
}

void
FLEnergy::SetD (double D)
{
  m_D = D;
}

void
FLEnergy::SetEpochs (double epochs)
{
  m_epochs = epochs;
}
double
FLEnergy::GetEpochs () const
{
  return m_epochs;
}

void
FLEnergy::SetModelSize (double modelSize)
{
  m_ModelSize = modelSize;
}
double
FLEnergy::GetModelSize () const
{
  return m_ModelSize;
}

void
FLEnergy::SetLearningModel (std::string name)
{
...
const std::string &
FLEnergy::GetLearningModel () const
{
  return m_learningModel;
}

void
FLEnergy::SetDeviceType (std::string deviceType)
{
  m_deviceType = deviceType;
}

const std::string &
FLEnergy::GetDeviceType () const
{
  return m_deviceType;
}

double
FLEnergy::CalcComputationalPower ()
{
...
double
FLEnergy::CalcTransmissionPower ()
{
  return m_tp;
}

double
FLEnergy::CalcTransmissionEnergy (double time)
{
  return m_tp * time;
}
double
FLEnergy::CalcComputationalEnergy (double time)
{
  long double n = m_C * (m_MAC * (100 + (6 * m_epochs))) * 600;
  long double d = m_freq * 1000000;
  double power = (n / d) + m_D;
