...
#ifndef FLWR_INTERFACE_H
#define FLWR_INTERFACE_H
...
namespace ns3 {
    ...
    /**
    * \ingroup flwr-interface
    * \brief Interface to flower
    */
    class FlwrProvider {
    public:
        ...
        /**
         * \brief Constructor; listening port for the flower
         *
         * \param port
         */
        FlwrProvider(uint16_t port) : m_port(port) {}

        /**
         * \brief Wait for flower to connect.
         */
