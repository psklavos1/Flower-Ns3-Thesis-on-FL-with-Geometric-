...
class CustomModel(keras.Model):
    ...
    def __init__(self, ds_name, ann_name, plot_model = False):
    ...
    def plot_my_model(self, ds_name: str):

        new_working_dir = "../model_pngs" 
        os.chdir(new_working_dir)
        print(os.getcwd())
        png_filepath = os.getcwd() + "/" + ds_name + ".png"
        
        plot_model(
            self.model,
            to_file=png_filepath,
            show_shapes=True,
    ...
    def _build_vgg(self, input_shape, num_classes):
        """
        Build a VGG16 model without pre-trained weights.
        ...
        Returns:
        - model: Keras Model, the VGG16 model
        """
        # Load VGG16 model without the top layer and without pre-trained weights
    ...
    def _build_fashion_mnist_model(self):
        ...
        self.logger.info("Enhanced Model built for Fashion MNIST")
        return model
    ...
    def _build_cifar10_model(self):
        ...
        self.logger.info("Default Model built for Fashion Cifar10")
