...
class DataManager:
    ...
    def plot_batch_data(
        ...
        data = self.data_handler.get_data("batch", client_id)
    ...
    def plot_epoch_data(
        ...
        data = self.data_handler.get_data("epoch", client_id)
        self.data_plotter.plot_data(
            plot_type,
            x,
            y,
    ...
    def plot_server_data(
        ...
        data = self.data_handler.get_data("server")
        self.data_plotter.plot_data(
            plot_type,
            x,
            y,
    ...
    def plot_info_data(
        ...
        data = self.data_handler.get_data("info")
        self.data_plotter.plot_data(
            plot_type,
            x,
            y,
